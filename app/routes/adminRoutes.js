...
router.get("/admin/locations", requireAuth, requireRole("admin"), admin.renderLocations);
...
router.post("/admin/locations", requireAuth, requireRole("admin"), admin.createLocation);
router.post("/admin/locations/:id/update", requireAuth, requireRole("admin"), admin.updateLocation);
router.post("/admin/locations/:id/delete", requireAuth, requireRole("admin"), admin.deleteLocation);
