...
Campus Activity Hub is a role based campus web app where students can see campus activity/busyness (Library/Rec/Dining) and create activities (study/workout/dinner) to invite friends, track RSVPs, and check in. Organizers/staff and admins have their own roles as well.
